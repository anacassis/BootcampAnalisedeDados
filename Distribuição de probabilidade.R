2.5 Estatística Computacional - Probabilidades com o R
###########################################################
...
hist(va_binomial) 
# A maior barra no histograma representa a quantidade esperada devendas
...
#Ao aplicar o comando na variável va_normal que acabmos de criar, ela ficará co média zero e desvio padrão unitário
